module github.com/akimimi/mqpf

go 1.16

require (
	gitee.com/akimimi/getuigo v0.0.0-20200507122450-bb8398c0d2f2 // indirect
	github.com/akimimi/config-loader v0.0.0-20210513164729-f29d10a82762
